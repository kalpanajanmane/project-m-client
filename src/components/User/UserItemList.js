...
import C from '../images/cross_icon.jpg'
...
{/* Consignment Details */}
          ...
          {formData.consignmentdetails?.itemdetails.map((consignment, index) => (
            <tr key={index}>
              ...
              <td>
                {index === editingIndex ? (
                  <>
                    <button type="button" onClick={handleUpdateConsignment} disabled={!isFormValid}>
                    <img
  ...
  <button type="button" onClick={() => handleCancelConsignment()}>
    ...
    />
                  ...
                  <>
                    <button type="button" onClick={() => handleEditConsignment(index)}>
                    <img
                    ...
                    <button type="button" onClick={() => handleDeleteConsignment(index)}>
                    <img
												className='admin-create-invoice-table-consigment-icon-low'
												src={D}
												alt='delete'
